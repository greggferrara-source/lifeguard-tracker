...
import {
    ...
    ChevronDown, ChevronRight, Bell, Wrench, Droplets, ClipboardList, TrendingDown, Award, Lightbulb, Search, Grid3x3 as LayoutIcon, Upload,
  } from "lucide-react";
...
const enterpriseGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Integrations", icon: Zap, page: "Integrations", ownerOnly: true, rootOnly: true },
