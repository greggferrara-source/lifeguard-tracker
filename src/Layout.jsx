...
import {
    ...
    ChevronDown, ChevronRight, Bell, Wrench, Droplets, ClipboardList, TrendingDown, TrendingUp, Award, Lightbulb, Search, Grid3x3 as LayoutIcon, Upload, Radio,
  } from "lucide-react";
...
const enterpriseGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Incident Management", icon: AlertTriangle, page: "IncidentManagement" },
      { name: "IoT Sensors", icon: Radio, page: "IoTSensorDashboard" },
      { name: "IoT Analytics", icon: BarChart2, page: "IoTAnalyticsDashboard" },
      { name: "Safety Predictions", icon: TrendingUp, page: "IoTAnalyticsDashboard" },
      { name: "Training Modules", icon: BookOpen, page: "TrainingModuleManager" },
      { name: "Training Gamification", icon: Trophy, page: "TrainingGamification" },
