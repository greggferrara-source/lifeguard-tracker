...
const plans = [
  {
    ...
    yearlyDiscount: null,
    description: "Perfect for small facilities with 1–49 users.",
    badge: null,
    color: "border-gray-200",
    btnClass: "bg-gray-900 hover:bg-gray-800 text-white",
    userRange: "1–49 users",
    features: [
      "1–49 users",
      "1 location",
  ...
  },
  {
    ...
    yearlyDiscount: null,
    description: "For growing aquatic programs with 51–499 users.",
    badge: "Most Popular",
    color: "border-[#1a9c5b]",
    btnClass: "bg-[#1a9c5b] hover:bg-[#158a4e] text-white",
    userRange: "51–499 users",
    features: [
      "51–499 users",
      "Up to 5 locations",
