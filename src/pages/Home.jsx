...
const benefits = [
  {
    tag: "SCHEDULING",
    title: "Eliminate Scheduling Headaches",
    body: "Stop wasting hours on manual schedules. LifeGuard Tracker lets you build, publish, and adjust shifts in minutes — from any device. Conflicts are flagged instantly before they become problems.",
    stat: "50% less time spent scheduling every week.",
    img: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=700&h=500&fit=crop&crop=center",
    imgAlt: "Scheduling dashboard on laptop",
    reverse: false,
  },
  {
    tag: "COMPLIANCE",
    title: "Never Miss a Certification Expiry",
    body: "Automated alerts notify you 30 and 7 days before any certification lapses. Keep your facility compliant, your staff qualified, and your audits stress-free — all without spreadsheets.",
    stat: "Zero compliance surprises with automated tracking.",
    img: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=700&h=500&fit=crop&crop=center",
    imgAlt: "Lifeguard certification check",
    reverse: true,
  },
  {
    tag: "TEAM COMMUNICATION",
    title: "Keep Everyone on the Same Page",
    body: "Broadcast announcements, send direct messages, and share shift changes in real time. Your entire aquatic team stays informed — no more missed group texts or confusing email chains.",
    stat: "Instant communication across all your locations.",
    img: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=700&h=500&fit=crop&crop=center",
    imgAlt: "Team communication",
    reverse: false,
  },
];
